...
export const purchaseTicketController = async (request, response) => {
    try {
        ...
        const busData = await busesDataModel.findById(busId);
...
//# sourceMappingURL=purchaseTicket.controller.js.map